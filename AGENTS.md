...
- [ ] Run `npx shadcn@latest init` and install Phase 1 components: `button input label card separator`
- [ ] App Router layout: `(auth)` and `(main)` route groups
- [ ] Site Header (desktop nav) + Bottom Nav (mobile)
- [ ] Login page (email/password + OAuth buttons)
- [ ] Register page (with password strength)
- [ ] Forgot Password + Reset Password pages
- [ ] `useAuthStore` Zustand store
- [ ] `src/middleware.ts` route protection
- [ ] `ThemeProvider` + `useThemeStore` (light/dark/system)
- [ ] `api-client.ts` with auth interceptor

### Phase 2 — Content Discovery
- [ ] Home page (hero banner, trending row, recently updated, genre chips)
- [ ] `MangaCard` component
- [ ] Advanced Search page with filter panel
- [ ] Browse page (by genre/tag/status)
- [ ] Library page (grid/list, sort/filter)

### Phase 3 — Detail Pages
- [ ] Manga/Novel detail page (cover, metadata, action buttons)
- [ ] `StarRating` widget (interactive + aggregate)
- [ ] Synopsis expand/collapse
- [ ] Chapter list (virtualized for 100+ chapters)
- [ ] Comment system (recursive thread, optimistic add/delete)
- [ ] Rating modal

### Phase 4 — Readers
- [ ] Novel Reader (typography controls, Day/Night/Sepia theme, scroll-to-progress)
- [ ] Manga Viewer — Vertical Scroll mode
- [ ] Manga Viewer — Single Page mode
- [ ] Manga Viewer — Double Page mode
- [ ] Image lazy-loading + pre-fetching hook
- [ ] Keyboard shortcuts hook

### Phase 5 — Translator Dashboard
- [ ] Dashboard home (groups list, uploads list)
- [ ] Group management page (members, invite)
- [ ] Upload Title form (stepped, with cover upload)
- [ ] Upload Chapter form (batch image upload, drag-to-reorder for manga; rich text for novel)

### Phase 6 — Notifications & Polish
- [ ] Notification bell + panel + polling hook
